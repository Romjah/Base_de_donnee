...
<html lang="en">
  ...
  <body>
        <div class="container">
            <div class="col-md-12">
                ...
                <div class="text-center">
                    <p><?= 'Bonjour cher utilisateur, vous êtes bien connecté' ?> </p>
        ...
        <div class="modal fade" id="change_password" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            ...
            <form method="get" action="historique_retrait.php">
                <p>
                    <input type="submit" value="Historique de retrait" />
                </p>
            </form>
            <form method="get" action="retrait.php">
                <p>
                    <input type="submit" value="page retrait" />
                </p>
            </form>
